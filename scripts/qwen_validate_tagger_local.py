...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate a Qwen tag extractor on a held-out JSONL set.")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("outputs/qwen_validation"))
