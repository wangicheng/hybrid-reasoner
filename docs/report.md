...
| :--- | :--- | :--- | :--- | :--- |
| **100 本** | Hybrid | 100.0% | 62.5% | 2.19 |
| | SinglePrompt | 100.0% | 4.2% | **2.06** |
| **500 本** | Hybrid | 100.0% | 51.4% | 2.34 |
| | SinglePrompt | 100.0% | 5.6% | **2.18** |
| **1000 本** | **Hybrid** | **100.0%** | **41.7%** | **2.41** |
| | SinglePrompt | 95.8% | 8.3% | 2.09 |
| **2000 本** | **Hybrid** | **100.0%** | **34.7%** | **2.35** |
| | SinglePrompt | 0.0% | 100.0% | N/A |
| **5000 本** | **Hybrid** | **100.0%** | **33.3%** | **2.54** |
| | SinglePrompt | 0.0% | 100.0% | N/A |
...
由下方的趨勢圖可見，**Hybrid 引擎展現了卓越的線性擴展性**。隨著可選書籍增加，Hybrid 引擎能有效利用更大的資料池，Avg@10 分數從 2.19 穩步上升至 2.54。反觀純 LLM，在超過 500 本後品質便開始下滑，在 2000 本以上時由於超過上下文限制，系統已無法運作。
...
xychart-beta
    ...
    y-axis "Avg@10 Score" 0 --> 3.0
    line [2.06, 2.18, 2.09, 0, 0]
    line [2.19, 2.34, 2.41, 2.35, 2.54]
```
...
### 4.5 實驗五：PermSC Reranking 權重與候選池的動態權衡
